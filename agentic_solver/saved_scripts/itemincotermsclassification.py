"""
ITEMINCOTERMSCLASSIFICATION Prediction - Anti-overfitting cascade with SHIPTOPARTY
Same structure as HEADERINCOTERMSCLASSIFICATION
"""
import pandas as pd
import json
...
def predict_itemincotermsclassification(row):
    ...
    # L2: SHIPTO+DT+ORG (min_support=3)
    k2 = f"{shipto}|{dt}|{org}"
